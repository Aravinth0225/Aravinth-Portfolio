        ...
        <div className="grid lg:grid-cols-12 gap-6 md:gap-8 items-start px-4">
          ...
          >
            <div className="space-y-6 md:space-y-8">
                  ...
                  <div>
                    ...
                    <p className="text-base md:text-lg lg:text-xl text-gray-600 dark:text-gray-300 leading-relaxed mb-4 md:mb-6">
                      ...
                      <span className="font-bold text-purple-600 dark:text-purple-400">
                        &nbsp; Sustainable Tech</span> with
                      <span className="font-bold text-green-600 dark:text-green-400"> Hands-on</span> of experience crafting
              ...
              <div className="grid md:grid-cols gap-4 md:gap-6">
                <motion.div
                  variants={itemVariants}
                ...
                >
                  <div className="flex items-start gap-3 md:gap-4 mb-3 md:mb-4">
                    <div className="p-2 md:p-3 bg-blue-500 rounded-lg md:rounded-xl shadow-lg">
                      <Icon icon="fa6-solid:graduation-cap" className="text-white w-5 md:w-6 h-5 md:h-6" width={24} height={24} />

                    </div>
                    <div>
                      <h4 className="font-bold text-gray-900 dark:text-white text-base md:text-lg">B.E - COMPUTER SCIENCE AND ENGINEERING</h4>
                      <p className="text-blue-600 dark:text-blue-400 font-medium text-sm md:text-base">Sona College Of Technology, Salem. </p>
                  ...
                  Actively engaged in building real-world projects using the MERN stack, organizing CTF competitions. Recognized for leadership and innovation across academic and tech events.
                  </p> */}
                </motion.div>
                ...
                >
                  <div className="flex items-start gap-3 md:gap-4 mb-3 md:mb-4">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 dark:text-white text-base md:text-lg">11TH & 12TH GRADE</h4>
                      <p className="text-green-600 dark:text-green-400 font-medium text-sm md:text-base">Kalaimagal Matric Higher Secondary School, Rasipuram, Namakkal.</p>
                      <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400 mt-1">2020 — 2022</p>
                    </div>
                  </div>
                  {/* <p className="text-gray-700 dark:text-gray-300 text-xs md:text-sm leading-relaxed mb-2 md:mb-3 flex-1">
                ...
                <motion.div
                   variants={itemVariants}
                    ...
                    <div>
                    <h4 className="font-bold text-gray-900 dark:text-white text-base md:text-lg">10TH GRADE</h4>
                    <p className="text-pink-600 dark:text-pink-500 font-medium text-sm md:text-base">
                     Kalaimagal Matric Higher Secondary School, Rasipuram, Namakkal.
                      </p>
                    <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400 mt-1">2019 — 2020</p>
                    </div>
                    </div>
                      {/* <p className="text-gray-700 dark:text-gray-300 text-xs md:text-sm leading-relaxed mb-2 md:mb-3 flex-1">
                         Consistently ranked among the top performers and built strong academic fundamentals during this phase.
                      </p> */}
                </motion.div>
              </div>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-50/90 to-pink-50/90 dark:from-purple-950/30 dark:to-pink-950/30 backdrop-blur-sm border border-white/30 dark:border-gray-700/40 shadow-xl">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <div>
                    <div className="text-sm font-bold text-gray-900 dark:text-white break-all">aravinthjaya525@gmail.com</div>
                  </div>
                </motion.a>
                ...
                >
                  ...
                  <div>
                    <div className="text-sm font-bold text-gray-900 dark:text-white">aravinthr.vercel.app</div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    <div className="text-sm font-bold text-gray-900 dark:text-white">Rasipuram, Namakkal</div>
                  </div>
                </motion.div>
              </div>
            </div>
