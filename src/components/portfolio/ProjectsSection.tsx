...
const projects = [
  {
    ...
    subtitle: "All-in-One Academic Toolkit for Students",
    description: "A comprehensive academic companion platform built for students to calculate GPA and CGPA across all departments and regulations. The system supports dynamic department additions, regulation-based syllabus for all semesters, and real-time academic scheduling.The platform offers detailed views of lab and class locations, as well as current CIE and semester exam schedules — all in one unified interface.",
    features: [
      "GPA & CGPA calculation for all departments and regulations",
      "Dynamic department and regulation management system",
      "Syllabus viewer for all 8 semesters, auto-filtered by department & regulation",
      "Real-time exam schedules including CIE and semester exams",
      "Regulation-wise academic structure with downloadable content",
      "Lightweight, user-friendly design with fast performance"
    ],
    deliverables: [
      "Fully functional academic platform deployed on the web",
      "GPA/CGPA calculator engine with dynamic data handling",
      "Integrated exam timetable dashboard",
      "College infrastructure mapping (labs, halls, classroom allocations)",
      "Department & syllabus management system",
      "Mobile-optimized responsive interface",
      "Responsive UI for both desktop and mobile users",
      "Integration with payment systems for premium features"
    ],
    tech: [
      "React js","Tailwind CSS","Node.js","React Hook Form","Framer Motion","Vercel (for deployment)"],
    github: "https://github.com",
    live: "https://sonacgpa.vercel.app",
  ...
  {
  title: "ByteBusters CTF",
  subtitle: "Capture The Flag Platform for Ethical Hacking Challenges",
  description: "A dynamic and competitive CTF (Capture The Flag) platform designed for cybersecurity events and college tech fests. Built to host a wide range of challenge categories, it offers real-time scoring, secure team authentication, and an intuitive admin panel for event coordination.",
  features: [
    "Team registration and secure login system",
    "Multiple challenge categories: Web, Forensics, Network, Python, and more",
    "Real-time scoreboard with automatic point tracking",
    "Challenge solving with flag submission validation",
    "Admin dashboard to manage challenges, scores, and teams",
    "CTF round-wise visibility and status control",
    "Responsive and clean UI Experience for desktop users",
    "Team-wise leaderboard and participation status"
  ],
  deliverables: [
    "Fully deployed CTF web application on production",
    "MongoDB-backed database with challenge , flags and team schemas",
    "JWT-based user authentication system",
    "Admin panel with challenge editor and score control",
    "Live scoreboard and challenge board components",
    "Desktop-optimized, event-ready web interface",
  ],
  tech: [
    "React.js",
    "Node.js",
    ...
    >
      ...
      >
        ...
        <SectionHeader
          ...
          description="Discover my latest work in web development, Skilled in crafting responsive web apps and developing scalable frontends with React js."
          showUnderline={true}
          centered={true}
        />
            ...
            >
              <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-2xl md:rounded-3xl border border-white/30 dark:border-gray-700/40 hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-500 overflow-hidden shadow-lg md:shadow-xl hover:shadow-xl md:hover:shadow-2xl">
                ...
                <div className={`relative bg-gradient-to-br ${project.gradient} p-4 sm:p-6 md:p-8 lg:p-10`}>
                  ...
                  <div className="hidden md:block absolute inset-0 opacity-50 group-hover:opacity-30 transition-opacity duration-500">
                    {[
                      { icon: "logos:react", pos: { top: "5%", left: "80%" } },
                      { icon: "logos:nextjs-icon", pos: { top: "60%", right: "4%" } },
                      { icon: "logos:typescript-icon", pos: { bottom: "20%", left: "75%" } },
                      { icon: "logos:nodejs-icon", pos: { top: "25%", right: "30%" } },
                      { icon: "logos:tailwindcss-icon", pos: { bottom: "30%", left: "85%" } },
                      { icon: "logos:vercel-icon", pos: { bottom: "15%", left: "65%" } },
                      { icon: "vscode-icons:file-type-html", pos: { top: "10%", left: "52%" } },
                      { icon: "vscode-icons:file-type-css", pos: { bottom: "12%", right: "10%" } },
                      { icon: "logos:mongodb-icon", pos: { top: "40%", left: "56%" } },
                      { icon: "simple-icons:express", pos: { bottom: "20%", left: "45%" } },
                      { icon: "simple-icons:netlify", pos: { top: "20%", right: "8%" } }
                    ].map((item, i) => (
                      <motion.div
                        key={i}
